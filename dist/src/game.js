...
class Game {
    constructor(snake, food, canvas, control) {
        ...
        this._score = 0;
        const randomFoodPositionX = Utils.getIntegerRandomNumberBetween(0, this.canvas.width) *
            this.canvas.multiplier;
        const randomFoodPositionY = Utils.getIntegerRandomNumberBetween(0, this.canvas.height) *
            this.canvas.multiplier;
